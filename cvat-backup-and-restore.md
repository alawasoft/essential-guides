...
docker run --rm --name temp_backup --volumes-from cvat_server -v $(pwd):/backup ubuntu bash -c "apt-get update && apt-get install -y bzip2 cd /home/django/data && tar -xvf /backup/cvat_data.tar.bz2 --strip 3"
```
